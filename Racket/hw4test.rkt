...
(define tests
  (test-suite
   ...
   ; sequence test 4
   (check-equal? (sequence 55 99 5) (list 55 60 65 70 75 80 85 90 95) "Sequence test 4")
   ...
   ; vector-assoc test
   (check-equal? (vector-assoc 4 (vector 2 (cons 3 1) "hi" (cons 5 1))) #f "vector-assoc test2")
